...
case_dir0 = "/lcrc/group/e3sm/ac.xzheng/E3SM_simulations/20180129.DECKv1b_piControl.ne30_oEC.edison"
experiment_name0 = "E3SMv1 piControl"

case_dir1 = "/lcrc/group/e3sm/ac.golaz/E3SM_analysis/20210527.v2rc2c.Fix2.ne30pg2_EC30to60E2r2.chrysalis"
experiment_name1 = "20210527.v2rc2c.Fix2"

case_dir2 = "/lcrc/group/e3sm/ac.golaz/E3SM_simulations/20210528.v2rc3c.piControl.ne30pg2_EC30to60E2r2.chrysalis"
experiment_name2 = "20210528.v2rc3c"

case_dir3 = "/lcrc/group/e3sm/ac.golaz/E3SM_simulations/20210528.v2rc3e.piControl.ne30pg2_EC30to60E2r2.chrysalis"
experiment_name3 = "20210528.v2rc3e"

figstr = sys.argv[3]
exps = [

 {'atmos':'{}/post/atm/glb/ts/monthly/10yr/glb.xml'.format(case_dir0),
  'ocean':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir0),
  'moc':'{}/post/ocn/glb/ts/monthly/10yr/'.format(case_dir0),
  'vol':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir0),
  'name': experiment_name0,
  'yoffset':0.0,
   'yr':(),
   'color':'Green'},

 {'atmos':'{}/post/atm/glb/ts/monthly/10yr/glb.xml'.format(case_dir1),
  'ocean':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir1),
  'moc':'{}/post/ocn/glb/ts/monthly/10yr/'.format(case_dir1),
  'vol':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir1),
  'name': experiment_name1,
  'yoffset':0.0,
   'yr':(),
   'color':'Blue'},

 {'atmos':'{}/post/atm/glb/ts/monthly/10yr/glb.xml'.format(case_dir2),
  'ocean':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir2),
  'moc':'{}/post/ocn/glb/ts/monthly/10yr/'.format(case_dir2),
  'vol':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir2),
  'name': experiment_name2,
  'yoffset':0.0,
   'yr':([151,550],[700,800],),
   'color':'Red'},

 {'atmos':'{}/post/atm/glb/ts/monthly/10yr/glb.xml'.format(case_dir3),
  'ocean':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir3),
  'moc':'{}/post/ocn/glb/ts/monthly/10yr/'.format(case_dir3),
  #'moc':None,
  'vol':'{}/post/ocn/glb/ts/monthly/10yr/glb.xml'.format(case_dir3),
  'name': experiment_name3,
  'yoffset':0.0,
   'yr':([151,550],[700,800],),
   'color':'Orange'},
